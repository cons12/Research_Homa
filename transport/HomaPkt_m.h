...
/**
 * Enum generated from <tt>../../homatransport/src/transport/HomaPkt.msg:25</tt> by nedtool.
 * <pre>
 * enum PktType
 * {
 * 
...
/**
 * Struct generated from ../../homatransport/src/transport/HomaPkt.msg:33 by nedtool.
 */
struct INET_API UnschedFields
{
    UnschedFields();
    uint32_t msgByteLen;
...
void INET_API doPacking(cCommBuffer *b, UnschedFields& a);
void INET_API doUnpacking(cCommBuffer *b, UnschedFields& a);

/**
 * Struct generated from ../../homatransport/src/transport/HomaPkt.msg:55 by nedtool.
 */
struct INET_API GrantFields
{
    GrantFields();
    uint16_t grantBytes;
    uint32_t offset;
...
void INET_API doPacking(cCommBuffer *b, GrantFields& a);
void INET_API doUnpacking(cCommBuffer *b, GrantFields& a);

/**
 * Struct generated from ../../homatransport/src/transport/HomaPkt.msg:68 by nedtool.
 */
struct INET_API SchedDataFields
{
    SchedDataFields();
    uint32_t firstByte;
    uint32_t lastByte;
...
void INET_API doPacking(cCommBuffer *b, SchedDataFields& a);
void INET_API doUnpacking(cCommBuffer *b, SchedDataFields& a);

/**
 * Class generated from <tt>../../homatransport/src/transport/HomaPkt.msg:78</tt> by nedtool.
 * <pre>
 * //
 ...
 *
 * <pre>
 * class INET_API HomaPkt : public HomaPkt_Base
 * {
 *   private:
 ...
 * </pre>
 */
class INET_API HomaPkt_Base : public ::cPacket
{
  protected:
